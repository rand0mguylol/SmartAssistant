...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static GUIContent m_drawSkybox = EditorGUIUtility.TrTextContent("Draw Skybox", "Controls whether Unity draws skybox or not.");
        ...
        void OnEnable()
        {
            ...
            m_drawSkybox = serializedObject.FindProperty("m_drawSkybox");
        ...
        void DrawAdvancedSettings()
        {
            ...
            if (m_AdvancedSettingsFoldout.value)
            {
                ...
                EditorGUILayout.PropertyField(m_drawSkybox, Styles.m_drawSkybox);
                EditorGUI.indentLevel--;
                EditorGUILayout.Space();
                EditorGUILayout.Space();
            }
